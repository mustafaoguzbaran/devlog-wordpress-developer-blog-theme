 ...
 * 
 * This template is used when "Blog" is set as the posts page in WordPress Settings > Reading
 * 
 * @package DevLog
 * @version 1.0.0
 */
            ...
            <div class="blog-header-content">
                ...
                <div class="blog-controls">
                    ...
                    <div class="category-pills">
                        <a href="<?php echo get_permalink(get_option('page_for_posts')); ?>" class="category-pill <?php echo !is_category() ? 'active' : ''; ?>">
                            Tümü
                        </a>
                        <?php 
            ...
            <?php else : ?>
                <div class="no-posts-modern">
                    ...
                    <p class="no-posts-description">
                        <?php if (is_search()) : ?>
                            "<strong><?php echo get_search_query(); ?></strong>" aramanız için sonuç bulunamadı.
                        <?php else : ?>
                            Henüz blog yazısı yayınlanmamış. Yakında yeni içerikler eklenecek.
                        <?php endif; ?>
                    </p>
